        ...
        <div class="row justify-content-center h-100">
                ...
                <ul class="nav nav-pills my-auto nav-flush flex-column mb-auto text-center">
                    <li class="nav-item">
                        <a href="./" class="nav-link py-3 border-bottom" aria-current="page" title="" data-bs-toggle="tooltip" data-bs-placement="right" data-bs-original-title="Stundenplan">
                            <svg viewBox="0 0 24 24" width="24" height="24" stroke="currentColor" stroke-width="2" fill="none" stroke-linecap="round" stroke-linejoin="round" class="sc-mensa-price">
            ...
            <div class="col h-100 overflow-auto">
                ...
                <div class="row">
                    <div class="col-12">
                        <div class="container">
                            <div class="row">
                                <h3 class="ms-3 mb-3 sc-mensa-day">{{day1}}</h3>
                    ...
                    <div class="col-12">
                        <div class="container">
                            <div class="row mt-4">
                                <h3 class="ms-3 mb-3 sc-mensa-day">{{day2}}</h3>
                                <div class="col-lg-4 col-12 mt-lg-0 mt-2">
                                    <div class="card" style="min-height: 200px;">
                                        <div class="card-body justify-content-center">
                                            <div class="row">
                    ...
                    <div class="col-12">
                        <div class="container">
                            <div class="row mt-4">
                                <h3 class="ms-3 mb-3 sc-mensa-day">{{day3}}</h3>
                                <div class="col-lg-4 col-12 mt-lg-0 mt-2">
                                    <div class="card" style="min-height: 200px;">
                                        <div class="card-body justify-content-center">
                                            <div class="row">
                    ...
                    <div class="col-12">
                        <div class="container">
                            <div class="row mt-4">
                                <h3 class="ms-3 mb-3 sc-mensa-day">{{day4}}</h3>
                                <div class="col-lg-4 col-12 mt-lg-0 mt-2">
                                    <div class="card" style="min-height: 200px;">
                                        <div class="card-body justify-content-center">
                                            <div class="row">
                    ...
                    <div class="col-12">
                        <div class="container">
                            <div class="row mt-4">
                                <h3 class="ms-3 mb-3 sc-mensa-day">{{day5}}</h3>
                                <div class="col-lg-4 col-12 mt-lg-0 mt-2">
                                    <div class="card" style="min-height: 200px;">
                                        <div class="card-body justify-content-center">
                                            <div class="row">
            ...
            <div class="col-3 sc-right-sidebar sc-bg-light">
                <div class="h-100 d-flex flex-column">
                    <div class="row justify-content-center sc-calendar-box">
                        <div>
                            <div>Kalendar</div>
                        </div>
                    </div>
                    <div class="row justify-content-center sc-task-box">
                        <div>Tasks</div>
                    </div>
                    <div class="row justify-content-center sc-mensa-box p-1" style="height: 25vh;">
