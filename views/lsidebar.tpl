            ...
            <div class="d-flex flex-column flex-shrink-0 sc-bg-light" style="width: 5rem;">
                <ul class="nav nav-pills my-auto nav-flush flex-column mb-auto text-center">
                    ...
                    <li>
                        ...
                        % tt_active = ""
                        % end
                        <a href="../../../calendar" class="nav-link {{tt_active}} py-3 border-bottom" title="" data-bs-toggle="tooltip" data-bs-placement="right" data-bs-original-title="Kalender">
                    ...
                    <li>
                        ...
                        % tt_active = ""
                        % end
                        <a href="../../../timetables" class="nav-link {{tt_active}} py-3 border-bottom" title="" data-bs-toggle="tooltip" data-bs-placement="right" data-bs-original-title="Stundenpläne">
                            <svg viewBox="0 0 24 24" width="24" height="24" stroke="currentColor" stroke-width="2" fill="none" stroke-linecap="round" stroke-linejoin="round" class="css-i6dzq1">
